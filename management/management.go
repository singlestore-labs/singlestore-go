...
const (
	...
	PendingCreation ClusterState = "PendingCreation"
...
// Cluster Represents information related to a cluster
type Cluster struct {
	// AllowAllTraffic Whether or not all traffic is allowed to the cluster
	...
	// Size Size of the cluster (in cluster size notation), such as S-00 or S-1
	Size string `json:"size"`

	// State State of the cluster
	State ClusterState `json:"state"`

	// TerminatedAt (If included in the output) The timestamp of when the cluster was terminated
	TerminatedAt *string `json:"terminatedAt,omitempty"`

	// Units Size of the cluster (in units), such as 0.25 or 1.0
	Units float32 `json:"units"`

	// Version The SingleStoreDB version
...
// ClusterCreate Represents the information specified while creating a cluster
type ClusterCreate struct {
	...
	// RegionID ID of the region where the new cluster is created
	RegionID openapi_types.UUID `json:"regionID"`

	// Size Size of the cluster, either in cluster size notation (e.g S-00) or in units (e.g. 0.25). The default value is "S-00".
	Size *string `json:"size,omitempty"`
}

// ClusterUpdate Represents the information specified while updating a cluster
...
type GetV0betaClustersParams struct {
	...
	IncludeTerminated *bool `form:"include-terminated,omitempty" json:"include-terminated,omitempty"`
...
type PostV0betaClustersJSONRequestBody = ClusterCreate
...
type PatchV0betaClustersClusterIdJSONRequestBody = ClusterUpdate
