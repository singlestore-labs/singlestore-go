...
// DeleteV1TeamsTeamIDMembersParams defines parameters for DeleteV1TeamsTeamIDMembers.
type DeleteV1TeamsTeamIDMembersParams struct {
	// MemberUserID Member user ID.
	MemberUserID *openapi_types.UUID `form:"memberUserID,omitempty" json:"memberUserID,omitempty"`

	// MemberTeamID Member team ID.
	MemberTeamID *openapi_types.UUID `form:"memberTeamID,omitempty" json:"memberTeamID,omitempty"`
}

// PostV1TeamsTeamIDMembersParams defines parameters for PostV1TeamsTeamIDMembers.
type PostV1TeamsTeamIDMembersParams struct {
	// MemberUserID Member user ID.
	MemberUserID *openapi_types.UUID `form:"memberUserID,omitempty" json:"memberUserID,omitempty"`
...
type ClientInterface interface {
	...
	// DeleteV1TeamsTeamIDMembers request
	DeleteV1TeamsTeamIDMembers(ctx context.Context, teamID TeamID, params *DeleteV1TeamsTeamIDMembersParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostV1TeamsTeamIDMembers request
	PostV1TeamsTeamIDMembers(ctx context.Context, teamID TeamID, params *PostV1TeamsTeamIDMembersParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) DeleteV1TeamsTeamIDMembers(ctx context.Context, teamID TeamID, params *DeleteV1TeamsTeamIDMembersParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteV1TeamsTeamIDMembersRequest(c.Server, teamID, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostV1TeamsTeamIDMembers(ctx context.Context, teamID TeamID, params *PostV1TeamsTeamIDMembersParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostV1TeamsTeamIDMembersRequest(c.Server, teamID, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewDeleteV1TeamsTeamIDMembersRequest generates requests for DeleteV1TeamsTeamIDMembers
func NewDeleteV1TeamsTeamIDMembersRequest(server string, teamID TeamID, params *DeleteV1TeamsTeamIDMembersParams) (*http.Request, error) {
	var err error
	...
	if params.MemberUserID != nil {
		...
		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "memberUserID", runtime.ParamLocationQuery, *params.MemberUserID); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.MemberTeamID != nil {

		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "memberTeamID", runtime.ParamLocationQuery, *params.MemberTeamID); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
...
// NewPostV1TeamsTeamIDMembersRequest generates requests for PostV1TeamsTeamIDMembers
func NewPostV1TeamsTeamIDMembersRequest(server string, teamID TeamID, params *PostV1TeamsTeamIDMembersParams) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// DeleteV1TeamsTeamIDMembers request
	DeleteV1TeamsTeamIDMembersWithResponse(ctx context.Context, teamID TeamID, params *DeleteV1TeamsTeamIDMembersParams, reqEditors ...RequestEditorFn) (*DeleteV1TeamsTeamIDMembersResponse, error)

	// PostV1TeamsTeamIDMembers request
	PostV1TeamsTeamIDMembersWithResponse(ctx context.Context, teamID TeamID, params *PostV1TeamsTeamIDMembersParams, reqEditors ...RequestEditorFn) (*PostV1TeamsTeamIDMembersResponse, error)
...
type DeleteV1TeamsTeamIDMembersResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *struct {
		// MemberTeamID Returned only if an existing member team was removed
		MemberTeamID *openapi_types.UUID `json:"memberTeamID,omitempty"`

		// MemberUserID Returned only if an existing member user was removed
		MemberUserID *openapi_types.UUID `json:"memberUserID,omitempty"`
	}
}

// Status returns HTTPResponse.Status
func (r DeleteV1TeamsTeamIDMembersResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r DeleteV1TeamsTeamIDMembersResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PostV1TeamsTeamIDMembersResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *struct {
		// MemberTeamID Returned only if a new member team was added
		MemberTeamID *openapi_types.UUID `json:"memberTeamID,omitempty"`

		// MemberUserID Returned only if a new member user was added
		MemberUserID *openapi_types.UUID `json:"memberUserID,omitempty"`
	}
}

// Status returns HTTPResponse.Status
func (r PostV1TeamsTeamIDMembersResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostV1TeamsTeamIDMembersResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// DeleteV1TeamsTeamIDMembersWithResponse request returning *DeleteV1TeamsTeamIDMembersResponse
func (c *ClientWithResponses) DeleteV1TeamsTeamIDMembersWithResponse(ctx context.Context, teamID TeamID, params *DeleteV1TeamsTeamIDMembersParams, reqEditors ...RequestEditorFn) (*DeleteV1TeamsTeamIDMembersResponse, error) {
	rsp, err := c.DeleteV1TeamsTeamIDMembers(ctx, teamID, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeleteV1TeamsTeamIDMembersResponse(rsp)
}

// PostV1TeamsTeamIDMembersWithResponse request returning *PostV1TeamsTeamIDMembersResponse
func (c *ClientWithResponses) PostV1TeamsTeamIDMembersWithResponse(ctx context.Context, teamID TeamID, params *PostV1TeamsTeamIDMembersParams, reqEditors ...RequestEditorFn) (*PostV1TeamsTeamIDMembersResponse, error) {
	rsp, err := c.PostV1TeamsTeamIDMembers(ctx, teamID, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostV1TeamsTeamIDMembersResponse(rsp)
}
...
// ParseDeleteV1TeamsTeamIDMembersResponse parses an HTTP response from a DeleteV1TeamsTeamIDMembersWithResponse call
func ParseDeleteV1TeamsTeamIDMembersResponse(rsp *http.Response) (*DeleteV1TeamsTeamIDMembersResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &DeleteV1TeamsTeamIDMembersResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParsePostV1TeamsTeamIDMembersResponse parses an HTTP response from a PostV1TeamsTeamIDMembersWithResponse call
func ParsePostV1TeamsTeamIDMembersResponse(rsp *http.Response) (*PostV1TeamsTeamIDMembersResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostV1TeamsTeamIDMembersResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
